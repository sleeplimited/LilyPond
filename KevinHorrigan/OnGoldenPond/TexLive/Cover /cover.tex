...
\end{tikzpicture}
\textsc{\resizebox{5cm}{!}{Kevin}}\\
\textsc{\resizebox{15cm}{!}{Horrigan}}\\[3cm]
\textsc{\Huge On Golden Pond}\\[.5cm]
for Solo Acoustic Six-String Guitar\\
B\textsubscript{1}F$\sharp$\textsubscript{2}D\textsubscript{3}G\textsubscript{3}B\textsubscript{3}D$\sharp$\textsubscript{4}\\
\vfill
