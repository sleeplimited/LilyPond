...
\override TextScript #'outside-staff-priority = ##f
  ...
  s1 |
  % Bar 21
  s2 s4-\mkTweak #0 #0 ^\lhfour \tsMove #0 #0 \strDampening s8\startTextSpan
  s8\stopTextSpan |
  % Bar 22
  \tsMove #0 #0 \strDampening s8\startTextSpan s8\stopTextSpan s4 s4 \tsMove #0 #0 \lhSpannerUp "4" { \grace s8 s8 s16 } s16 |
  % Bar 23
  s2. \tsMove #0 #0 \strDampening s8\startTextSpan s8\stopTextSpan |
  % Bar 24
  \tsMove #0 #0 \strDampening s8\startTextSpan s8\stopTextSpan s2. |
  % Bar 25
  s2. \tsMove #0 #0 \strDampening s8\startTextSpan s8\stopTextSpan |
  % Bar 26
  \tsMove #0 #0 \strDampening s8\startTextSpan s8\stopTextSpan s2. |
  % Bar 27
  s2. s8 \tsMove #0 #0 \strDampening s8\startTextSpan |
  % Bar 28
  %% String-damping for this string is located at dynamicsOne
  s8 s8\stopTextSpan s4 s8 \tsMove #0 #0 \textSpannerUp \lhSpannerUp "1" { s8 s8 s16 s16 } |
  % Bar 29
  ...
  s2. s8 \tsMove #0 #0 \strDampening s8\startTextSpan  |
  % Bar 32
  s8 s8\stopTextSpan s2 s8 \tsMove #0 #0 \strDampening s8\startTextSpan |
  % Bar 33
  ...
  % Bar 75
  s16 } s16 s16 \tsMove #0 #0 \lhSpannerUp "2" { s16 s8 s8 s4 s8 s8 }
  % Bar 76
  s1 |
  % Bar 77
  s8 \tsMove #0 #0 \lhSpannerUp "2" {s16 s16 s8 s8 } s4 s16 s8.-\mkTweak #0
  #0 ^\lhfour |
  % Bar 78
  s1 |
  % Bar 79
  s4 s16 s16 s8 s4 s16 s8.-\mkTweak #0 #0
  ^\twostrupstrm |
  % Bar 80
  s1 |
  % Bar 81
...
\override TextScript #'outside-staff-priority = ##f
  ...
  s1 |
  % Bar 16
  s2 s4 s8 s8-\mkTweak #1 #-2.9 ^\markup { \draw-line #'(4 . 1) } |
  % Bar 17
  s1 |
  % Bar 18
  s1 |
  ...
  s8\startTextSpan |
  % Bar 36
  s8 s16 s16\stopTextSpan s2 s8-\mkTweak #-0.7 #-3 ^\oneStrFlick s8 |
  % Bar 37
  s8 s16 s16 s2 s4-\mkTweak #-0.7 #-3 ^\oneStrFlick |
  % Bar 38
  s4 s16 s16 s8 s2 |
  % Bar 39 
  s1 |
  ...
  s1 |
  % Bar 66
  s4 s4 \textSpannerDown \tsMove #0 #0.5 \lhSpannerDown "1" { s4 s8-\mkTweak
...
\override TextScript #'outside-staff-priority = ##f
  ...
  % Bar 10
  \textSpannerNeutral
  s2 s4 s4-\mkTweak #-1.0 #4.1 _\twoStrMFlick
  % Bar 11
  s1 
  % Bar 12
  s2. s8 s8 
  ...
  s16\stopTextSpan  \mkMove #0 #-11 s8^\lhthree |
  % Bar 21
  ...
  % Bar 22
  s4 \tsMove #-0.1 #7.98 \strDampening s16\startTextSpan s16\stopTextSpan s8 s2 |
  % Bar 23
  s4 \tsMove #-0.1 #7.15 \strDampening s16\startTextSpan s16\stopTextSpan s8 s4
  \textSpannerUp  \tsMove #-0.12 #-7.94 \threeStrDamp s8\startTextSpan s8\stopTextSpan |
  % Bar 24
  s4 \tsMove #-0.1 #7.98 \strDampening s16\startTextSpan s16\stopTextSpan s8 s2 |
  % Bar 25
  s4 \tsMove #-0.1 #7.15 \strDampening s16\startTextSpan s16\stopTextSpan s8 s4
  ...
  s4 \tsMove #-0.1 #7.98 \strDampening s16\startTextSpan s16\stopTextSpan s8 s2 |
  % Bar 27
  \textSpannerDown \tsMove #0 #-2 \lhSpannerDown "2" { s8 s8 s8 s8 s16 } s8.
  \textSpannerDown \tsMove #-0.12 #8.5 \threeStrDamp s16\startTextSpan s16\stopTextSpan
  s8-\mkTweak #0 #-11 ^\lhtwo |
  % Bar 28
  \textSpannerDown \tsMove #0 #-2 \lhSpannerDown "2" { s8 s8 s8 s8 s16 } s8.
  \textSpannerNeutral \tsMove #-0.12 #-11.12 \threeStrDamp s16\startTextSpan s16\stopTextSpan
  s8-\mkTweak #0 #-11 ^\lhtwo |
  % Bar 29
  ...
  % Bar 47
  s4 s16 s16 s8 s4
  \tsMove #-0.12 #7.9 \threeStrDamp s16\startTextSpan s16\stopTextSpan s8 |
  % Bar 48
  s4 s16 s16 s8 s4
  \tsMove #-0.12 #7.9 \threeStrDamp s16\startTextSpan s16\stopTextSpan s8 |
  % Bar 49
  ...
  \lhSpannerDown "2" {s8 s4 s4-\mkTweak #-0.5 #-3.72 ^\twoStrFlick
  % Bar 75
  s16 } s16 \textSpannerUp \tsMove #0 #0 \lhSpannerUp "3" {s8 s8 s8 s4 s8 s8 }
  % Bar 76
...
\override TextScript #'outside-staff-priority = ##f
  ...
  % Bar 75
  s4 \tsMove #-0.12 #9.72 \twoStrDamp s16\startTextSpan s16\stopTextSpan s8 s4 s8 s16 s16 |
  % Bar 76
  s4 s4 s4 \tsMove #-0.12 #5.08 \twoStrDamp s8\startTextSpan s16\stopTextSpan s16 |
  % Bar 77
  s4 \tsMove #-0.12 #7.49 \strDampening s16\startTextSpan s16\stopTextSpan s8 s4 \tsMove
  #-0.12 #6.09 \twoStrDamp s16\startTextSpan s8.\stopTextSpan |
  % Bar 78
  s2 s4 \tsMove #-0.12 #5.08 \twoStrDamp s8\startTextSpan s8\stopTextSpan |
  % Bar 79
  s4 \tsMove #-0.12 #4.75 \strDampening s16\startTextSpan s16\stopTextSpan s8 s4-\mkTweak #-1.2 #-6 ^\fivestrdwnstrm \tsMove
  #-0.12 #6.08  
  ...
  s2 s4 \tsMove #-0.12 #5.08 \twoStrDamp s8\startTextSpan s8\stopTextSpan |
  % Bar 83
  s4 \tsMove #-0.12 #4.75 \strDampening s16\startTextSpan s16\stopTextSpan s8 s4-\mkTweak #-1.2 #-6 ^\fivestrdwnstrm s4 |
...
\override TextScript #'outside-staff-priority = ##f
  ...
  _\snare\startTextSpan s16\stopTextSpan \tsMove #0 #-7.49 \strDampening
  s8\startTextSpan s4\stopTextSpan \tsMove #0 #-7.49 \strDampening
  s8-\mkTweak #-0.04 #-1.9 _\snare\startTextSpan s8\stopTextSpan |
  % Bar 10
  s4 \tsMove #0 #-7.49 \strDampening s16-\mkTweak #-0.04 #-2.3
  _\snare\startTextSpan s16\stopTextSpan \tsMove #0 #-7.49 \strDampening
  s8\startTextSpan s4\stopTextSpan \tsMove #-0.1 #-8.08 \strDampening
  s8-\mkTweak #-0.04 #-2 _\snare\startTextSpan s8\stopTextSpan |
  % Bar 11
  s4 \tsMove #0 #-8.08 \strDampening s16-\mkTweak #-0.04 #-2.3
  _\snare\startTextSpan s16\stopTextSpan \tsMove #0 #-8.08 \strDampening
  s8\startTextSpan s4\stopTextSpan  \tsMove #0 #-8.08 \strDampening
  s8-\mkTweak #-0.04 #-1.9 _\snare\startTextSpan s8\stopTextSpan |
  % Bar 12
  ...
  % Bar 25
  s4 s4-\mkTweak #-0.04 #-2.3 _\bassSnare s4 s4-\mkTweak #-0.04 #-1.9 _\bassSnare |
  % Bar 26
  s4 s4-\mkTweak #-0.04 #-2.3 _\bassSnare s2 |
  %%
  %% Bar 27
  ...
  s4 s4-\mkTweak #0.15 #-0.9 _\bass s4 s4-\mkTweak #-0.04 #-2.3 _\snare |
  % Bar 29
  s4 s4-\mkTweak #-0.04 #-2.8 _\bass s4 s4-\mkTweak #-0.04 #-1.9 _\snare |
  % Bar 30
  ...
  % Bar 32
  s4 s4-\mkTweak #-0.04 #-2.3 _\bass s4 s4-\mkTweak #-0.04 #-2.3 _\snare |
  % Bar 33
  s4 s4-\mkTweak #0.15 #-1.3 _\bass s4 s4-\mkTweak #-0.04 #-1.9 _\snare |
  % Bar 34
  s4 s8-\mkTweak #-0.04 #-2.3 _\bass s8 s4 } s4 |
  % Bar 35
  s4 s4-\mkTweak #0.15 #-1.3 _\bass s4 s4-\mkTweak #-0.04 #-2.3 _\snare |
  % Bar 36
  s4 s4-\mkTweak #-0.04 #-2.3 _\bass s4 s4-\mkTweak #-0.04 #-2.3 _\bassSnare |
  %% 
  %% Bar 37
  %%
  s4 s4-\mkTweak #-0.04 #-2.3 _\snare s4 s4-\mkTweak #-0.04 #-1.9 _\bassSnare |
  % Bar 38
  s4 s8-\mkTweak #-0.04 #-1.9 _\snare s8
  ...
  s1 |
  % Bar 47
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-2.5 _\snare |
  % Bar 48
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-2.5 _\snare |
  % Bar 49
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-1.9 _\snare |
  % Bar 50
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-1.9 _\snare |
  % Bar 51
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-2.5 _\snare |
  ...
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-1.9 _\snare |
  % Bar 54
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4 |
  % Bar 55
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-2.5 _\snare |
  % Bar 56
  s4 s4-\mkTweak #-0.04 #-2.5 _\bass s4 s4-\mkTweak #-0.04 #-2.5 _\snare |
  ...
  % Bar 76
  s4 \tsMove #0 #3.73 \strDampening s16\startTextSpan -\mkTweak #-0.04 #-2.3
  _\snare s16\stopTextSpan \tsMove #0 #3.73 \strDampening s8\startTextSpan
  s4\stopTextSpan \tsMove #-0.1 #3.24 \strDampening s8\startTextSpan -\mkTweak #-0.04 #-1.9 _\snare s8\stopTextSpan |
  % Bar 77
