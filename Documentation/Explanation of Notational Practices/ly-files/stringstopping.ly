...
\override TextSpanner #'extra-offset = #'(0.0 . 13.45)
...
\override TextSpanner #'color = #(x11-color "plum")
\override TextSpanner #'layer = #-1
\override TextSpanner #'extra-offset = #'(0.0 . 13.8)
...
\override TextSpanner #'color = #(x11-color "plum")
\override TextSpanner #'layer = #-1
\override TextSpanner #'extra-offset = #'(0.0 . 13.66)
...
dynamicssix = {
\override TextScript #'extra-offset = #'(-0.7 . 9.4)
